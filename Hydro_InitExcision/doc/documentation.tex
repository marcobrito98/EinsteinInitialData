...
\title{Whisky\_InitExcision - Initial Excision for Whisky}
...
\begin{abstract}
  This thorn is initialising the excision-spacemask for Whisky to
  specified forms.
\end{abstract}
...
\begin{verbatim}
whisky_initexcision::whisky_initexcision_type = <TYPE>
\end{verbatim}
